...
2. `qa/INDONESIAN_FINAL_VISUAL_QA_REPORT_2026-09-10.md` records the QA-time PDF digest `930d3629eb31aca5141009a7470689c0abfcb874e9e76d7c8c0bfba84cab6e6c`. The PDF shipped in this package hashes to `6fc4cda84a8e247c3332297b589da35c7ff3487cad0dc667ff38bd8183ee94b1`, indicating the PDF was re-rendered from the QA-passed DOCX after that report was written. The DOCX digest is unchanged from the QA report (`a0993eb666f55381507e9c91bd7ecdf57f701499bfe6c65274684b3b3f6197cc`), so the QA-inspected document state is intact; only the PDF rendering pass is not byte-traceable to the report. `SHA256SUMS.txt` is authoritative for what this package actually contains.
